...
Now, that we had that, it is time to start building the Github pipeline for pushing the page to my other Github repository that houses my website hosting.